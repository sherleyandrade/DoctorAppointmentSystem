...
<head>
  ...
  <link rel="stylesheet" href="viewappointments3.css">
...
<div class="responsive">
    <div class="navigation"><br><br>
        <ul>
            ...
            <li  style="background-color: #014;"><a href="#"><i class="fas fa-address-card"></i>&nbsp;&nbsp;&nbsp;View Appointments</a></li>
...
<?php
        ...
        ?>
    <tr><td>Doctor</td><td><?php echo $Dname ?></td></tr>
    ...
    <tr><td>Time</td><td><?php
     if($slot_time>'11')
      ...
      ?></td></tr>
    <tr><td>Date</td><td><?php echo $slot_date; ?></td></tr>
